...
# open the PDF file
pdf_file = open(r'C:\Users\innas\OneDrive\Рабочий стол\workers\salaries\sal-slip-archive\sal-06-2024.pdf', 'rb')
...
for page_num in range(len(pdf_reader.pages)):
    ...
    for worker_id, worker in workers.items():
        ...
        if text.find(worker_id) != -1:
            # create a new file
            page_file_name = rf'{workers_base_folder}\{name}\salaries\{prefix}-{worker_id}-' \
